...
// tĩnh kích thước FILTER_HISTORY_SIZE thay cho std::vector để tránh cấp
// phát động trên heap và tăng tốc xử lý trên vi điều khiển.
...
private:
    float _rawHistory[FILTER_HISTORY_SIZE];
