...
description: Secrets responder (read-only). Use when asked to scan files/diffs for leaked credentials (CoreIoT tokens, Wi-Fi passwords, API keys) or when a scan/verify reports a secret-hit.
---
